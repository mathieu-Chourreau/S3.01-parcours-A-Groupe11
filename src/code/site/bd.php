...
$username = "lferme001_bd"; // Remplacez ceci par votre nom d'utilisateur
$password = "lferme001_bd"; // Remplacez ceci par votre mot de passe
$dbname = "lferme001_bd"; // Remplacez ceci par le nom de votre base de données
