                    ...
                    <form id="formulaireGram" action="envoi_bd.php" method="post">
                        <div id="selectGrm">
                            <?php foreach ($ingredients as $ingredient) {
                                ...
                                echo "<label class='ingre-label' for='grammage_" . $ingredient . "'>$ingredient</label><input id='grammage_" . $ingredient . "' type='number' name='grammage_" . $ingredient . "' class='grammage-input' placeholder='Grammage' min ='0' onkeyup='if(this.value<0){this.value= this.value * -1}'>";
                            } ?>
